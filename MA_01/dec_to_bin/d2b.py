...
DecBinTuple = (float, [list[int], list[int]], int) #(decimal, binary -> [fractional, integer], sign)
...
def result_string(my_decimal : float, my_binary : list[list[int], list[int]], sign : int, width : int=(MAX_DIGITS + 2)) -> str:
